...
- create_artifact(kind, title, files?, source?, entry?, dependencies?) — create a renderable artifact for the chat panel. kind is one of: static-html | static-react | mermaid | file-tree. Use mermaid for diagrams; static-html for self-contained pages; static-react for component demos; file-tree for grouped file snapshots. Live previews use create_live_preview (separate tool) since they need sandbox-side orchestration.
