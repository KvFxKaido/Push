...
Options:
  --provider <name>             ollama | openrouter | zen | nvidia | fireworks | deepseek | sakana | openai | anthropic | google | xai (default: ollama)
...
async function handleProviderCommand(arg, ctx, state, config) {
  ...
  if (!target) {
    process.stdout.write(
      `Unknown provider: ${arg}. Use: ollama, openrouter, zen, nvidia, fireworks, deepseek, sakana, openai, anthropic, google, xai\n`,
    );
    return;
  }
