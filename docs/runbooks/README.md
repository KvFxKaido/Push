...
| `Design Token Migration Plan.md` | Draft plan, P0–P3 shipped 2026-05-25 | Scopes the hardcoded-color backlog (buckets + concentration + phased P0–P3) behind the `check:design-tokens` ratchet. P0 carveout, P1 34 mechanical swaps, P2 3 chat/library tokens, P3 29 drift snaps (baseline 441 → 142); tail (neutrals, near-blacks, one arbitrary-property form) pending. |
