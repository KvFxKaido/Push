...
| `Workspace Publish to GitHub Plan.md` | Current, added 2026-04-05 | Product and implementation plan for first-class in-app repo creation as a workspace-publish flow, using the existing sandbox promotion plumbing and explicit private/public visibility. |
...
4. Workspace-to-GitHub publishing and in-app repo creation, now with a focused follow-up in `Workspace Publish to GitHub Plan.md`.
