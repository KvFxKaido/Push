...
| `Design Token Migration Plan.md` | Draft plan, P0–P2 shipped 2026-05-25 | Scopes the hardcoded-color backlog (buckets + concentration + phased P0–P3) behind the `check:design-tokens` ratchet. P0 carved out the CodeMirror theme, P1 did 34 mechanical swaps, P2 added 3 chat/library tokens (baseline 441 → 264); P3 + tail pending. |
