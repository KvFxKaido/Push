...
| `Design Token Migration Plan.md` | Draft plan, added 2026-05-25 | Scopes the 441-violation hardcoded-color backlog (buckets + concentration + phased P0–P3) behind the `check:design-tokens` ratchet. No migration executed yet. |
