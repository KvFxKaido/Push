...
| `Test Coverage Plan.md` | Current, Phase 1 shipped 2026-04-17 | Post-audit coverage push. Phase 1 (security-critical surface) landed in PRs #309/#310; Phases 2–6 outlined with target files and acceptance bars. |
