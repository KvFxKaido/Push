...
| `Runtime Unification Plan.md` | Current, Phase 1 lead slice implemented, added 2026-07-17 | Converges shared Coder policy/interventions first, then provider-family adapters, capability resolution, and execution-ledger consumers without collapsing shell-specific boundaries. |
