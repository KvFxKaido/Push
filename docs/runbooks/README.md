...
| `Design Token Migration Plan.md` | Draft plan, P0–P4 shipped 2026-05-25 | Scopes the hardcoded-color backlog behind the `check:design-tokens` ratchet. P0 codemirror carveout, P1 34 mechanical swaps, P2 3 chat/library tokens, P3 29 drift snaps, P4 data-color carveouts (language/repo-accent/crash-fallback) (baseline 441 → 112; inline-style hexes now zero); Tailwind-palette-shade tail pending. |
