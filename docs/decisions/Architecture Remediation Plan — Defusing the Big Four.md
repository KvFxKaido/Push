...
With Gap 1, Gap 2, and Gap 3 Step 1 now shipped, the live gaps are Gap 3 Steps 2–5. The downstream-dependency narrative that motivated Gap 2's urgency has largely discharged — updated notes below preserve the decision trail for a re-read six weeks from now.
