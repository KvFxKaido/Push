...
| `Architecture Remediation Plan — Defusing the Big Four.md` | Draft, added 2026-04-14 | Working discussion plan for the four dense coordination modules flagged by every panel: tracing spine, verification-family extraction, shim decision, and policy-to-runtime hardening. |
