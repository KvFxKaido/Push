...
Concrete JSON Schemas for this protocol live in `docs/cli/schemas/`:
- `docs/cli/schemas/push-runtime-envelope.schema.json` (entrypoint)
- `docs/cli/schemas/push-runtime-request-envelope.schema.json`
- `docs/cli/schemas/push-runtime-response-envelope.schema.json`
- `docs/cli/schemas/push-runtime-event-envelope.schema.json`
- `docs/cli/schemas/push-runtime-defs.schema.json`
