...
Related policies:
- Mistral: `docs/security/PROVIDER_USAGE_POLICY.md`
- OpenRouter: `docs/security/PROVIDER_USAGE_POLICY_OPENROUTER.md`
- Z.AI: `docs/security/PROVIDER_USAGE_POLICY_ZAI.md`
- Google Gemini: `docs/security/PROVIDER_USAGE_POLICY_GOOGLE.md`
...
4. If terms changed materially, document required product/config changes in `docs/runbooks/`.
