...
Owner: Push
Related:
- `documents/plans/Workspace Route Follow-up Plan.md` — route-boundary cleanup that made the current workspace/chat shell possible
- `documents/plans/UX Nice-to-Haves Plan.md` — longer-tail chat UX ideas and quality-of-life follow-ups
