...
*   **Sandbox Mode:** Ephemeral workspace (no GitHub repo). Entry via onboarding or the launcher/home surface. GitHub tools blocked; 30-min lifetime with expiry warning. Download as tar.gz.
