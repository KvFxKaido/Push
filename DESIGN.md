...
| `GLASS_SURFACE` / `…_HOVER`        | `border-white/[0.06] bg-white/[0.02]` + hover lift   | Resting tinted tile — repo cards, the tab tray + cells                          |
| `GLASS_ACTIVE_CLASS`               | Accent tint + ring + soft glow (`--push-accent-rgb`) | Active/selected tile — live repo card, live tab cell      |
