...
**Models are replaceable; roles are not.** The user picks a backend (Ollama, OpenRouter, Zen, Nvidia, Fireworks, Sakana, or Kilo Code); all agents use it.
...
Current priorities from `docs/archive/runbooks/Harness Reliability Plan.md`:
