...
**OpenRouter** provides access to 50+ models through a single API. Push includes 19 curated models: Claude Sonnet 4.6, Opus 4.6, and Haiku 4.5, GPT-5.4 Pro and GPT-5.4, 2 Codex variants (5.3/5.2), Step 3.5 Flash (free), Gemini 3.1 Pro Preview/3.1 Flash Lite Preview, Mistral Large 3, Devstral 2, Mistral Medium 3.1, MiniMax M2.5/M2.1, GLM 4.7/5.0, Grok 4.1, and Kimi K2.5.
