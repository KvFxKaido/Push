...
**OpenRouter** provides access to 50+ models through a single API. Push includes 10 curated models: Claude Sonnet 4.6, Opus 4.6, and Haiku 4.5, 2 Codex variants (5.2/5.1), Step 3.5 Flash (free), Qwen3 Coder (free), DeepSeek R1 0528 (free), Gemini 3 Flash, and Grok 4.1.
