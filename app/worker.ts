...
const EXACT_API_ROUTES: ExactApiRoute[] = [
  ...
  { path: '/api/fireworks/chat', method: 'POST', handler: handleFireworksChat },
  { path: '/api/fireworks/models', method: 'GET', handler: handleFireworksModels },
  ...
  { path: '/api/deepseek/chat', method: 'POST', handler: handleDeepSeekChat },
  { path: '/api/deepseek/models', method: 'GET', handler: handleDeepSeekModels },
  { path: '/api/sakana/chat', method: 'POST', handler: handleSakanaChat },
  { path: '/api/sakana/models', method: 'GET', handler: handleSakanaModels },
  ...
  { path: '/api/google/chat', method: 'POST', handler: handleGoogleChat },
  { path: '/api/google/models', method: 'GET', handler: handleGoogleModels },
