...
export default defineConfig([
  ...
  // config doesn't load. Treat it as a build artifact, not source. The
  // electron/ entries are that platform's regenerated halves (synced web
  // bundle, plugin registration, tsc output, packaged builds, vendored
  // runtime) — gitignored, but present locally, and generated/plugins.mjs
  // carries the same foreign eslint-disable directives as the Android bridge.
  globalIgnores([
    'dist',
    'android',
    'electron/app',
