...
const BUILT_IN_PROVIDER_BUILDERS = {
  ...
  zai: ({ catalog, ...args }) => ({
    hasKey: catalog.zai.hasKey,
    model: catalog.zai.model,
    setModel: catalog.zai.setModel,
    modelOptions: catalog.zaiModelOptions,
    modelsLoading: catalog.zaiModels.loading,
    modelsError: catalog.zaiModels.error,
    modelsUpdatedAt: catalog.zaiModels.updatedAt,
    isModelLocked: isLockedByProvider(args, 'zai'),
    refreshModels: catalog.refreshZaiModels,
    keyInput: catalog.zai.keyInput,
    setKeyInput: catalog.zai.setKeyInput,
    setKey: catalog.zai.setKey,
    clearKey: catalog.zai.clearKey,
  }),
  kimi: ({ catalog, ...args }) => ({
    hasKey: catalog.kimi.hasKey,
    model: catalog.kimi.model,
    setModel: catalog.kimi.setModel,
    modelOptions: catalog.kimiModelOptions,
    modelsLoading: catalog.kimiModels.loading,
    modelsError: catalog.kimiModels.error,
    modelsUpdatedAt: catalog.kimiModels.updatedAt,
    isModelLocked: isLockedByProvider(args, 'kimi'),
    refreshModels: catalog.refreshKimiModels,
    keyInput: catalog.kimi.keyInput,
    setKeyInput: catalog.kimi.setKeyInput,
    setKey: catalog.kimi.setKey,
    clearKey: catalog.kimi.clearKey,
  }),
  huggingface: ({ catalog, ...args }) => ({
    hasKey: catalog.huggingface.hasKey,
    model: catalog.huggingface.model,
    setModel: catalog.huggingface.setModel,
    modelOptions: catalog.huggingfaceModelOptions,
    modelsLoading: catalog.huggingfaceModels.loading,
    modelsError: catalog.huggingfaceModels.error,
    modelsUpdatedAt: catalog.huggingfaceModels.updatedAt,
    isModelLocked: isLockedByProvider(args, 'huggingface'),
    refreshModels: catalog.refreshHuggingFaceModels,
    keyInput: catalog.huggingface.keyInput,
    setKeyInput: catalog.huggingface.setKeyInput,
    setKey: catalog.huggingface.setKey,
    clearKey: catalog.huggingface.clearKey,
  }),
  zen: ({ catalog, ...args }) => ({
