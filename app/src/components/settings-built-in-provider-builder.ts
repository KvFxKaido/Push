...
const BUILT_IN_PROVIDER_BUILDERS = {
  ...
  blackbox: ({ catalog, ...args }) => ({
    ...
    isModelLocked: isLockedByModel(args, 'blackbox'),
  ...
  kilocode: ({ catalog, ...args }) => ({
    ...
    isModelLocked: isLockedByModel(args, 'kilocode'),
  ...
  openadapter: ({ catalog, ...args }) => ({
    ...
    isModelLocked: isLockedByModel(args, 'openadapter'),
