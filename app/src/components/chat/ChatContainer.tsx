...
function ResumeBanner({
  ...
  return (
    <div
      className={`mx-4 mt-5 mb-1 flex items-center justify-between gap-3 px-3.5 py-3 animate-fade-in ${HUB_PANEL_SUBTLE_SURFACE_CLASS} border-amber-500/20 bg-[linear-gradient(180deg,rgba(52,40,15,0.22)_0%,rgba(24,18,7,0.42)_100%)]`}
    >
