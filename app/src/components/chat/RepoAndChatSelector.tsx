    ...
    <DropdownMenu open={open} onOpenChange={setOpen}>
      ...
      >
          ...
          <>
            ...
            {onBrowseRepos && (
              <DropdownMenuItem
                ...
                className="mx-1 mt-1 flex cursor-pointer items-center gap-2.5 rounded-lg px-3 py-2 text-push-link hover:bg-push-surface-hover hover:text-push-link-hover"
              >
        ...
        <DropdownMenuItem
          ...
          className="mx-1 flex cursor-pointer items-center gap-2.5 rounded-lg px-3 py-2.5 text-push-link hover:bg-push-surface-hover hover:text-push-link-hover"
        >
