...
function buildProps(
  ...
  const providerControls: NonNullable<ComponentProps<typeof ChatInput>['providerControls']> = {
    ...
    sakanaModel: 'fugu',
    sakanaModelOptions: ['fugu'],
    sakanaModelsLoading: false,
    sakanaModelsError: null,
    sakanaModelsUpdatedAt: null,
    isSakanaModelLocked: false,
    refreshSakanaModels: vi.fn(),
    onSelectSakanaModel: vi.fn(),
    ...
    deepseekModelOptions: ['deepseek-v4-pro', 'deepseek-v4-flash'],
    deepseekModelsLoading: false,
    deepseekModelsError: null,
    deepseekModelsUpdatedAt: null,
    isDeepSeekModelLocked: false,
    refreshDeepSeekModels: vi.fn(),
    onSelectDeepSeekModel: vi.fn(),
    azureModel: 'gpt-4.1',
    azureDeployments: [],
