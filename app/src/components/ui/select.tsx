      ...
      >
        ...
        <SelectPrimitive.Popup
          ...
          className={cn(
            ...
            position === "popper" &&
              "data-[side=bottom]:translate-y-1 data-[side=left]:-translate-x-1 data-[side=right]:translate-x-1 data-[side=top]:-translate-y-1 min-w-[var(--anchor-width)] scroll-my-1",
            className
          )}
          {...props}
        >
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpArrow
      ...
      className={cn(
        "bg-popover top-0 z-[1] flex w-full cursor-default items-center justify-center rounded-t-md py-1",
        className
      )}
      {...props}
    >
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownArrow
      ...
      className={cn(
        "bg-popover bottom-0 z-[1] flex w-full cursor-default items-center justify-center rounded-b-md py-1",
        className
      )}
      {...props}
    >
