...
interface ChatScreenProps {
  ...
  handleSelectMistralModelFromChat: (model: string) => void;
  handleSelectOpenRouterModelFromChat: (model: string) => void;
  handleSelectMinimaxModelFromChat: (model: string) => void;
...
export function ChatScreen(props: ChatScreenProps) {
  const {
    ...
    handleSelectMistralModelFromChat,
    handleSelectOpenRouterModelFromChat,
    handleSelectMinimaxModelFromChat,
  ...
  const settingsSheet = (
    <SettingsSheet
      ...
      ai={{
        ...
        ollamaKeyInput: '', // Key inputs are managed locally in settings
        setOllamaKeyInput: () => {},
