...
function baseProps(overrides: Partial<ChatRouteProps> = {}): ChatRouteProps {
  return {
    ...
    switchBranchFromUI: vi.fn(async () => ({ ok: true as const })),
    mergeBranchInUI: vi.fn(),
    repos: [],
    reposLoading: false,
    reposError: null,
    branches: {} as never,
    catalog: { availableProviders: [], activeProviderLabel: 'zen' } as never,
    ...
    handleSelectZaiModelFromChat: vi.fn(),
    handleSelectKimiModelFromChat: vi.fn(),
    handleSelectHuggingFaceModelFromChat: vi.fn(),
    handleSelectCloudflareModelFromChat: vi.fn(),
    handleSelectCloudflareGatewayModelFromChat: vi.fn(),
    handleSelectZenModelFromChat: vi.fn(),
    handleSelectFireworksModelFromChat: vi.fn(),
    handleSelectSakanaModelFromChat: vi.fn(),
