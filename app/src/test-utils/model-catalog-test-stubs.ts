...
export function makeDaemonModelCatalogStub(opts: {
  ...
  return {
    ...
    cloudflareGateway: makeProviderStub(),
    zen: makeProviderStub(),
    zai: makeProviderStub(),
    kimi: makeProviderStub(),
    huggingface: makeProviderStub(),
    ...
    kimiModels: { loading: false, error: null, updatedAt: null },
    huggingfaceModels: { loading: false, error: null, updatedAt: null },
    ...
    refreshKimiModels: vi.fn(),
    refreshHuggingFaceModels: vi.fn(),
