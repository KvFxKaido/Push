...
function formatSuggestedAskUserPath(path: AskUserCardData): string {
  const optionLines = path.options.map(
    (option) =>
    ...
    return [
      {
        ...
        expandedPrompt:
          'Help me turn a rough idea into something concrete and actionable. Keep it collaborative, and aim to leave me with a clearer direction plus a tangible next step in this workspace.',
          ...
          options: [
            {
              id: 'product',
              label: 'Product idea',
              description: 'A feature, app, or user experience concept',
            },
            {
              id: 'workflow',
              label: 'Workflow idea',
              description: 'An automation, script, or process improvement',
            },
            {
              id: 'technical',
              label: 'Technical idea',
              description: 'An architecture, refactor, or implementation direction',
            },
            {
              id: 'describe',
              label: "I'll describe it",
              description: 'Let me explain the idea in my own words',
            },
          ],
        },
      },
      {
        ...
        expandedPrompt:
          'Create a concise, practical design doc in /workspace that I can build from. Prefer something implementation-oriented over a vague brainstorm.',
        suggestedAskUserPath: {
          ...
          options: [
            {
              id: 'feature',
              label: 'Feature spec',
              description: 'Goals, flows, requirements, and edge cases',
            },
            {
              id: 'technical',
              label: 'Technical plan',
              description: 'Architecture, components, data flow, and rollout',
            },
            {
              id: 'architecture',
              label: 'Architecture note',
              description: 'Tradeoffs, decisions, and system shape',
            },
            {
              id: 'template',
              label: 'Start from a template',
              description: 'Give me a clean starter doc to fill in',
            },
          ],
        },
      },
      {
        ...
        expandedPrompt:
          'Scaffold a small project in /workspace with sensible structure, starter files, config, and a short README so I can start iterating quickly.',
        suggestedAskUserPath: {
          ...
          options: [
            {
              ...
              description: 'TypeScript-first app or tool with modern config',
            },
            {
              id: 'python',
              label: 'Python',
              description: 'Simple Python project with clear entrypoint and packaging',
            },
            {
              id: 'go',
              label: 'Go',
              description: 'Minimal Go module with clean package structure',
            },
            {
              id: 'rust',
              label: 'Rust',
              description: 'Cargo project with a straightforward starter layout',
            },
          ],
        },
      },
