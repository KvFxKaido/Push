...
describe('project-instructions-utils', () => {
  ...
  it('syncs the filename for the first non-empty sandbox instruction file', async () => {
    ...
    expect(readInstruction).toHaveBeenNthCalledWith(1, 'sandbox-1', '/workspace/AGENTS.md');
    expect(readInstruction).toHaveBeenNthCalledWith(2, 'sandbox-1', '/workspace/CLAUDE.md');
