...
- **DO NOT echo infrastructure markers** ([TOOL_RESULT], [/TOOL_RESULT], [meta], [TOOL_CALL_PARSE_ERROR]) in your responses. These are system plumbing. Extract and use only the actual data inside. Your output must be clean — no delimiters, no telemetry lines.
