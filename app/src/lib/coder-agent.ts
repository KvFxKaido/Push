...
- **Never echo infrastructure markers** ([TOOL_RESULT], [/TOOL_RESULT], [meta], [TOOL_CALL_PARSE_ERROR], [CODER_STATE], [FILE_AWARENESS]) in your responses. These are system plumbing — extract and use only the actual data inside.
