...
export interface Env {
  ...
  // explicitly here. handleZenGoChat proxies raw Anthropic Messages SSE for the
  ...
  /** Kill switch for the sandbox-backed PR reviewer (inspection + verification
   *  tools over the checked-out PR head). Enabled by default; set `'0'` to
   *  disable and force diff-only reviews. */
