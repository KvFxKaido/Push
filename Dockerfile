...
# .nvmrc, CI). Unlike Dockerfile.sandbox / sandbox/app.py — which are pinned to
# the Cloudflare sandbox base image's Node 20 and must move together — this
# image has a clean base and serves the CLI, where Node 24 is already required.
