...
/** Env var that toggles the Auditor commit gate across surfaces. */
export const AUDITOR_GATE_ENV_VAR = 'PUSH_AUDITOR_GATE';

/**
 * Default state when nothing explicitly opts in: ON. The Auditor commit gate
...
/**
 * Resolve whether the Auditor commit gate is enabled. Pure — callers pass the
