...
const PROVIDER_MODEL_METADATA: Record<string, Record<string, DeclaredModelMetadata>> = {
  openrouter: {
    ...
    'arcee-ai/virtuoso-large': M(131072, false, true, false, TEXT, TEXT, false),
    ...
    'qwen/qwen3.6-plus-preview:free': M(262144, true, true, false, TEXT_IMAGE_VIDEO),
    'stepfun/step-3.5-flash': M(262144, true, true, false, TEXT, TEXT, false),
    'x-ai/grok-4.1-fast': M(2000000, true, true, false, TEXT, TEXT, false),
