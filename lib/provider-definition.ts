...
export const PROVIDER_DEFINITIONS: readonly ProviderDefinition[] = [
  ...
  },
  {
    ...
    models: ZAI_MODELS,
    apiKeyEnvVars: ['PUSH_ZAI_API_KEY', 'ZAI_API_KEY', 'VITE_ZAI_API_KEY'],
    webProxyPath: '/api/zai/chat',
    modelsProxyPath: '/api/zai/models',
    icon: {
      src: 'https://docs.z.ai/favicon.ico',
      alt: 'Z.ai logo',
      fallbackText: 'Z',
    },
    settings: {
      description:
        'Z.ai direct - GLM coding and agent models through the OpenAI-compatible Chat Completions API',
      envKey: 'VITE_ZAI_API_KEY',
      envUrl: 'https://api.z.ai/api/paas/v4',
      modelContextWindow: 1_000_000,
      keyStorageKey: 'zai_api_key',
      modelStorageKey: 'zai_model',
      builtInOrder: 25,
      keyPlaceholder: 'Z.ai API key',
      keySaveLabel: 'Save Z.ai key',
      keyHint: 'Z.ai API key from the Z.ai Open Platform.',
    },
    cli: {
      order: 25,
      defaultUrl: 'https://api.z.ai/api/paas/v4/chat/completions',
      urlEnvVars: ['PUSH_ZAI_URL', 'ZAI_API_URL'],
      modelEnvVar: 'PUSH_ZAI_MODEL',
    },
  },
  {
    id: 'kimi',
    ...
    models: KIMI_MODELS,
    apiKeyEnvVars: ['PUSH_KIMI_API_KEY', 'MOONSHOT_API_KEY', 'KIMI_API_KEY', 'VITE_KIMI_API_KEY'],
    webProxyPath: '/api/kimi/chat',
    modelsProxyPath: '/api/kimi/models',
    icon: {
      src: 'https://platform.kimi.ai/favicon.ico',
      alt: 'Kimi logo',
      fallbackText: 'K',
    },
    settings: {
      description:
        'Kimi direct - K2 coding and agent models through the OpenAI-compatible Chat Completions API',
      envKey: 'VITE_KIMI_API_KEY',
      envUrl: 'https://platform.kimi.ai',
      modelContextWindow: 262_144,
      keyStorageKey: 'kimi_api_key',
      modelStorageKey: 'kimi_model',
      builtInOrder: 24,
      keyPlaceholder: 'Kimi API key',
      keySaveLabel: 'Save Kimi key',
      keyHint: 'Kimi API key from the Kimi Developer Platform.',
    },
    cli: {
      order: 24,
      defaultUrl: 'https://api.moonshot.ai/v1/chat/completions',
      urlEnvVars: ['PUSH_KIMI_URL', 'KIMI_API_URL'],
      modelEnvVar: 'PUSH_KIMI_MODEL',
    },
  },
  {
    id: 'huggingface',
    ...
    apiKeyEnvVars: [
      'PUSH_HUGGINGFACE_API_KEY',
      'HF_TOKEN',
      'HUGGINGFACE_API_KEY',
      'VITE_HUGGINGFACE_API_KEY',
    ],
    webProxyPath: '/api/huggingface/chat',
    modelsProxyPath: '/api/huggingface/models',
    icon: {
    ...
    settings: {
      description:
        'Hugging Face Inference Providers - open-weight models from many hosts through the OpenAI-compatible router',
      envKey: 'VITE_HUGGINGFACE_API_KEY',
      envUrl: 'https://router.huggingface.co/v1',
      modelContextWindow: 262_144,
      keyStorageKey: 'huggingface_api_key',
      modelStorageKey: 'huggingface_model',
      builtInOrder: 26,
      keyPlaceholder: 'Hugging Face token (hf_...)',
      keySaveLabel: 'Save Hugging Face token',
      keyHint:
        'Hugging Face access token with Inference Providers permission (hf.co/settings/tokens).',
    },
    cli: {
      order: 26,
      defaultUrl: 'https://router.huggingface.co/v1/chat/completions',
      urlEnvVars: ['PUSH_HUGGINGFACE_URL', 'HUGGINGFACE_API_URL'],
      modelEnvVar: 'PUSH_HUGGINGFACE_MODEL',
    },
  },
  {
    id: 'cloudflare',
  ...
  },
  {
    ...
    models: XAI_MODELS,
    apiKeyEnvVars: ['PUSH_XAI_API_KEY', 'XAI_API_KEY', 'VITE_XAI_API_KEY'],
    webProxyPath: '/api/xai/chat',
    modelsProxyPath: '/api/xai/models',
    icon: {
    ...
    settings: {
      description: 'xAI direct — Grok models via the OpenAI-compatible Responses API',
      envKey: 'VITE_XAI_API_KEY',
      envUrl: 'https://api.x.ai',
      modelContextWindow: 500_000,
      keyStorageKey: 'xai_api_key',
      modelStorageKey: 'xai_model',
      builtInOrder: 45,
      keyPlaceholder: 'xAI API key',
      keySaveLabel: 'Save xAI key',
      keyHint: 'xAI API key from console.x.ai. Direct /v1/responses with Grok models.',
    },
    cli: {
      order: 115,
      defaultUrl: 'https://api.x.ai/v1/responses',
      urlEnvVars: ['PUSH_XAI_URL'],
      modelEnvVar: 'PUSH_XAI_MODEL',
    },
  },
  {
    id: 'google',
